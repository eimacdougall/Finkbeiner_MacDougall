...
#Plot 5
importance = evaluate.ablation_importance(model_classification, test_images, test_labels, metric='mse', save_path="models/feature_ablation_importance.png")

plt.figure(figsize=(10,5))
plt.bar(range(len(importance)), importance)
plt.xlabel("Feature Index")
plt.ylabel("Ablation Importance (Δ MSE)")
